...
from net_module.trial4_cmdn_module import ConvMDN
...
csv_path  = os.path.join(Path(__file__).parent.parent, 'Data/SimpleAvoid2m1c/all_data.csv')
data_dir  = os.path.join(Path(__file__).parent.parent, 'Data/SimpleAvoid2m1c/')
