...
save_path = None#os.path.join(Path(__file__).parent.parent, 'Model/trial1_model') # if None, don't save
...
myDH = DataHandler(dataset, batch_size=batch_size, shuffle=True, validation_prop=validation_prop, validation_cache=5)
